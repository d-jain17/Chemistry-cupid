...
class Hydrogen : AppCompatActivity() {
    ...
    fun goToImage1(view: View) {
        val image1 = findViewById<ImageView>(R.id.hydroCartoon1)
        val image2 = findViewById<ImageView>(R.id.hydroCartoon2)
        val image3 = findViewById<ImageView>(R.id.hydroCartoon3)
