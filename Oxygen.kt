...
class Oxygen : AppCompatActivity() {
    ...
    fun goToImage1(view: View) {
        val image1 = findViewById<ImageView>(R.id.oxygenCartoon1)
        val image2 = findViewById<ImageView>(R.id.oxygenCartoon2)
        val image3 = findViewById<ImageView>(R.id.oxygenCartoon3)
